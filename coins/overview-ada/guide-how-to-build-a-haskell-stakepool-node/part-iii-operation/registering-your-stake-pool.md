...
Next, upload your **poolMetaData.json** to a Web site that you administer or a public Web site. For example, you can [upload pool metadata to GitHub](../part-v-tips/uploading-pool-metadata-to-github.md)
