...
Create a new SSH key pair on **your client machine**. Run this on **your client machine,** not remote node.  Update the comment with your email or a comment.
...
<summary>Option 1: Transfer with ssh-copy-id</summary>
